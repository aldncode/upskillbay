  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 py-12">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#4F46E5]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-[#7C3AED]/4 rounded-full blur-3xl" />
      </div>
      ...
      >
        <div className="rounded-2xl border border-slate-200/60 bg-white/80 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-sm">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">Start building real skills for your career</p>
          </div>

          <div className="mb-6 rounded-xl bg-gradient-to-r from-[#4F46E5]/5 to-[#7C3AED]/5 px-4 py-3">
          ...
          <button className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3 text-sm font-medium text-slate-700 transition-all hover:border-slate-300 hover:bg-slate-50">
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            ...
            <Link href="/auth/login" className="font-semibold text-[#4F46E5] hover:text-[#4338CA]">
              Sign in
            </Link>
          </p>
        </div>
